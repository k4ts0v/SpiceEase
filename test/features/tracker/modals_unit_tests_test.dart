...
void main() {
  ...
  setUp(() {
    ...
    when(mockController.updateTask(
        ...
        .thenAnswer((_) async {});
    when(mockController.deleteTask(any)).thenAnswer((_) async {});
    when(mockController.addHabit(
      title: anyNamed('title'),
      description: anyNamed('description'),
      frequency: anyNamed('frequency'),
    )).thenAnswer((_) async {});
    when(mockController.updateHabit(any, any, any, any, any, any))
        .thenAnswer((_) async {});
    when(mockController.deleteHabit(any)).thenAnswer((_) async {});
