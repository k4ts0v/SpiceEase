...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get calendarStyleHeaderFormatButtonVisible =>
      'Botón de formato visible';

  @override
  String get calendarStyleHeaderTitleCentered =>
      'Título del encabezado centrado';
  ...
  String get breakIntoSubtasksPrompt =>
      '¿Quieres dividir esta tarea en subtareas?';
  ...
  String get titleRequiredForSubtasks =>
      'El título es obligatorio para las subtareas';
  ...
  String get kanbanDescription =>
      'Visualiza tu flujo de trabajo con tarjetas organizadas en columnas para seguir el progreso.';
  ...
  String get timeBlocksDescription =>
      'Programa tu día en bloques de tiempo dedicados para aumentar el enfoque y la productividad.';
  ...
  String get flowmodoroDescription =>
      'Trabaja mientras te sientas productivo, luego recarga energías con un descanso proporcional.';
  ...
  String get estimateInstructions =>
      'Da la estimación en números. Para rangos de números, sepáralos usando \'a\'.';
  ...
  String get unscheduleTaskConfirmation =>
      '¿Deseas eliminar esta tarea de la agenda? Permanecerá en tu lista de tareas.';
  ...
  String get flowmodoroExplanation =>
      'Concéntrate en una tarea a la vez con intervalos de trabajo y descanso';
  ...
  String get timeToFocusAgain =>
      '¡Es hora de volver a concentrarte en tu tarea!';
  ...
  String get speedrunDescription =>
      'Ponte a prueba completando tareas en un tiempo limitado. Cuanto más rápido termines, más puntos ganarás.';
  ...
  String get diceRollerDescription =>
      'Tira un dado para generar números aleatorios para tus tareas. Úsalo para saber cuántos elementos tienes que completar.';
  ...
  String get incompleteSubtasksWarning =>
      'Algunas subtareas aún no se han completado.';
  ...
  String get alwaysShowCriticalDescription =>
      'Las notificaciones críticas se mostrarán independientemente de los niveles de energía o síntomas';
  ...
  String get lowEnergyDescription =>
      'Cuando tu energía esté por debajo de este nivel, solo se mostrarán notificaciones de alta prioridad';
  ...
  String get highSymptomDescription =>
      'Cuando tus síntomas estén por encima de este nivel, solo se mostrarán notificaciones críticas';
  ...
  String get configureNotificationPreferences =>
      'Configura cómo y cuándo aparecen las notificaciones';

  @override
  String get viewPastNotifications =>
      'Ver notificaciones recibidas anteriormente';
  ...
  String get taskReminderDescription =>
      'Recordatorio diario para revisar tareas pendientes';

  @override
  String get habitReminderDescription =>
      'Recordatorio diario para verifica el progreso de hábitos';

  @override
  String get medicationReminderDescription =>
      'Recordatorio diario para tomar medicamentos';

  @override
  String get symptomReminderDescription =>
      'Recordatorio diario para registrar síntomas';

  @override
  String get energyReminderDescription =>
      'Recordatorio diario para registrar niveles de energía';
  ...
  String get specificRemindersDescription =>
      'Establecer recordatorios individuales';
  ...
  String get storagePermissionRequired =>
      'Se requiere permiso de almacenamiento para exportar/importar datos';
  ...
  String get dataProtectionDesc =>
      'Tus datos se almacenan localmente en tu dispositivo y no se comparten con terceros';
  ...
  String get analyticsDesc =>
      'Ayuda a mejorar la app enviando datos de uso anónimos';
  ...
  String get crashReportingDesc =>
      'Enviar reportes de errores para ayudar a corregir bugs';
  ...
  String get appCrashesDescription =>
      'La aplicación deja de responder o se cierra inesperadamente';
  ...
  String get performanceDescription =>
      'La aplicación funciona lentamente o tarda en cargar';
  ...
  String get stillHavingIssues =>
      '¿Sigues teniendo problemas? Contacta al soporte para ayuda personalizada.';
  ...
  String get checkStorageSpace =>
      'Verifica que tengas suficiente espacio de almacenamiento (necesitas al menos 100MB libres)';
  ...
  String get clearAppCache =>
      'Limpia caché de la aplicación en configuración del dispositivo';
  ...
  String get ensureNoFilters =>
      'Asegúrate de que no hay filtros aplicados que puedan ocultar tus datos';
  ...
  String get closeBackgroundApps =>
      'Cierra otras aplicaciones ejecutándose en segundo plano';

  @override
  String get clearOldData =>
      'Limpia datos antiguos que ya no necesites (Configuración > Gestión de Datos)';
  ...
  String get unableToLoadVersionInfo =>
      'No se puede cargar la información de la versión';
  ...
  String get suggestFeaturesOnGitHub =>
      'Sugerir nuevas características en GitHub';
  ...
  String get gitHubIssueUrlCopied =>
      'URL de incidencia de GitHub copiada en el portapapeles';
  ...
  String get unableToOpenLinkAutomatically =>
      'No se puede abrir el enlace automáticamente. Copie este enlace y ábralo en su navegador:';
  ...
  String get unableToShowLicenses =>
      'Imposible mostrar licencias en este momento';
  ...
  String get describeAlternativesDescription =>
      'Una descripción clara y concisa de cualquier solución alternativa o función que hayas considerado.';
  ...
  String get useCaseDescription =>
      'Describe cómo se usaría esta función y quién se beneficiaría de ella.';
  ...
  String get faqKanbanBoardsAnswer =>
      'Los tableros Kanban te ayudan a visualizar tu flujo de trabajo con columnas como \"Por Hacer\", \"En Progreso\" y \"Hecho\". Puedes arrastrar tareas entre columnas para registrar su estado y ver tu progreso de un vistazo.';
  ...
  String get faqTimeBlocksAnswer =>
      'El bloqueo de tiempo es un método de programación donde asignas franjas horarias específicas a diferentes actividades o tipos de trabajo. Esto te ayuda a mantenerte enfocado y asegura que las tareas importantes tengan tiempo dedicado.';

  @override
  String get faqCustomizeTimers =>
      '¿Puedo personalizar las duraciones del temporizador?';

  @override
  String get faqCustomizeTimersAnswer =>
      '¡Sí! Puedes ajustar los períodos de trabajo, duraciones de descanso e intervalos de descanso largo en la configuración del temporizador para coincidir con tu ritmo de productividad personal.';

  @override
  String get faqEnergyTaskScheduling =>
      '¿Cómo afecta mi nivel de energía la programación de tareas?';

  @override
  String get faqEnergyTaskSchedulingAnswer =>
      'La app considera tu energía diaria al sugerir la programación de tareas. Los períodos de alta energía son mejores para tareas complejas y demandantes, mientras que los períodos de baja energía se reservan para actividades más simples y rutinarias. La IA aprende tus patrones con el tiempo para sugerir el momento óptimo para diferentes tipos de trabajo.';

  @override
  String get faqSymptomRatingsAccuracy =>
      '¿Qué tan precisas deberían ser mis calificaciones de síntomas?';

  @override
  String get faqSymptomRatingsAccuracyAnswer =>
      'Usa una escala consistente (1-10) y trata de ser lo más objetivo posible. La escala 1-10 está basada en la [Escala de Dolor Mankoski](https://www.painscale.com/article/mankoski-pain-scale), que proporciona descripciones específicas para cada nivel (1 = apenas perceptible, 10 = inconsciente por el dolor). La clave es la consistencia a lo largo del tiempo en lugar de la precisión perfecta en entradas individuales.';
  ...
  String get faqCustomSymptomsAnswer =>
      '¡Sí! Puedes agregar tipos de síntomas personalizados más allá de los predeterminados. Esto te permite registrar cualquier cosa específica a tu condición de salud.';
  ...
  String get faqDataStorageAnswer =>
      'Actualmente, todos tus datos se almacenan en una base de datos en la nube. Sin embargo, el desarrollador está trabajando en implementar una solución de almacenamiento local y una forma para que los usuarios auto-alojen sus datos si lo prefieren.';
  ...
  String get faqMultipleDevicesAnswer =>
      '¡Sí! Como tus datos se almacenan en una base de datos en la nube, puedes acceder a ellos desde cualquier dispositivo siempre que hayas iniciado sesión en tu cuenta.';
  ...
  String get faqDeleteAppAnswer =>
      'Tus datos permanecerán almacenados de forma segura en la base de datos en la nube. Puedes reinstalar la app e iniciar sesión nuevamente en tu cuenta para acceder a todos tus datos.';
  ...
  String get faqDataMissingAnswer =>
      'Verifica que tengas una conexión a internet activa. Revisa si estás viendo la fecha correcta. Si el problema persiste, intenta cerrar sesión y volver a iniciarla en tu cuenta para refrescar la sincronización de datos.';
  ...
  String get faqAppSlowAnswer =>
      'Intenta reiniciar la app primero. Si los problemas persisten, puedes limpiar la caché y datos de la app en la Configuración de tu teléfono > Apps > SpiceEase > Almacenamiento.';

  @override
  String get faqFeatureMissing =>
      'No puedo encontrar una función que usaba antes';

  @override
  String get faqFeatureMissingAnswer =>
      'Las funciones pueden estar ubicadas en diferentes secciones después de las actualizaciones. Revisa la sección de ayuda o usa la función de búsqueda para encontrar lo que estás buscando.';
  ...
  String get tutorialUnderstandingIconGrid =>
      'Entendiendo la Cuadrícula de Iconos';
  ...
  String get tutorialTaskEstimationTimePlanning =>
      'Estimación de Tareas y Planificación de Tiempo';
  ...
  String get tutorialAddingMedicationTracking =>
      'Añadiendo Seguimiento de Medicamentos';

  @override
  String get tutorialRecordingMoodEntries =>
      'Registrando Entradas de Estado de Ánimo';

  @override
  String get tutorialRecordingEnergyEntries =>
      'Registrando Entradas de Energía';
  ...
  String get tutorialSchedulingTimeBlocks =>
      'Programando con Bloques de Tiempo';

  @override
  String get tutorialUnderstandingReportsCharts =>
      'Entendiendo Reportes y Gráficos';

  @override
  String get tutorialCustomizingReportViews =>
      'Personalizando Vistas de Reportes';
  ...
  String get tutorialIconGridStep1 =>
      'La pantalla principal muestra una cuadrícula de iconos con diferentes categorías';

  @override
  String get tutorialIconGridStep2 =>
      'Cada icono representa un tipo diferente de datos que puedes rastrear';

  @override
  String get tutorialIconGridStep3 =>
      'Toca cualquier icono para ver tus entradas existentes para esa categoría';

  @override
  String get tutorialIconGridStep4 =>
      'Usa el botón \"+\" dentro de cada categoría para añadir nuevas entradas';

  @override
  String get tutorialIconGridStep5 =>
      'Alternativamente, para hábitos, medicamentos, tareas o síntomas, usa los botones \"Añadir [Elemento]\" para acceso rápido';

  @override
  String get tutorialIconGridStep6 =>
      'El diseño de cuadrícula facilita ver todas tus opciones de seguimiento';

  @override
  String get tutorialListViewStep1 =>
      'Toca el icono de lista en la navegación inferior para cambiar a vista de lista';

  @override
  String get tutorialListViewStep2 =>
      'La lista muestra todos tus elementos agrupados por tipo (tareas, hábitos, etc.)';

  @override
  String get tutorialListViewStep3 =>
      'Los elementos están codificados por colores por categoría para fácil identificación';

  @override
  String get tutorialListViewStep4 =>
      'Puedes ver el estado de finalización y fechas de vencimiento de un vistazo';

  @override
  String get tutorialListViewStep5 =>
      'Toca cualquier elemento para ver detalles o marcarlo como completo';

  @override
  String get tutorialListViewStep6 =>
      'Usa las opciones de filtro y ordenación para organizar tu vista';

  @override
  String get tutorialListViewStep7 =>
      'Cambia de vuelta a vista de cuadrícula en cualquier momento usando el icono de cuadrícula';
  ...
  String get tutorialFirstTaskStep2 =>
      'Elige el icono de tarea de la cuadrícula de iconos O toca el botón \"Añadir Tarea\"';

  @override
  String get tutorialFirstTaskStep3 =>
      'Si usas la cuadrícula de iconos: toca el botón \"+\" en la esquina superior derecha';

  @override
  String get tutorialFirstTaskStep4 =>
      'Ingresa un título y descripción para tu tarea';

  @override
  String get tutorialFirstTaskStep5 =>
      'Establece una fecha de vencimiento si deseas y un nivel de prioridad';

  @override
  String get tutorialFirstTaskStep6 =>
      'Añade subtareas si es necesario presionando el botón \"Dividir en subtareas\"';
  ...
  String get tutorialEditTaskStep1 =>
      'Navega al icono de tarea en la cuadrícula';

  @override
  String get tutorialEditTaskStep2 =>
      'Toca cualquier tarea existente para abrirla';

  @override
  String get tutorialEditTaskStep3 =>
      'Para editar: toca el botón de editar y modifica cualquier campo';

  @override
  String get tutorialEditTaskStep4 =>
      'Puedes cambiar título, descripción, fecha de vencimiento o prioridad';

  @override
  String get tutorialEditTaskStep5 =>
      'Para eliminar: toca el botón de eliminar y confirma';
  ...
  String get tutorialSubtasksStep1 =>
      'Al crear o editar una tarea, toca \"Dividir en subtareas\"';

  @override
  String get tutorialSubtasksStep2 =>
      'Esto genera automáticamente una lista de subtareas bajo la tarea principal';

  @override
  String get tutorialSubtasksStep3 =>
      'Cada subtarea puede marcarse como completa independientemente y tiene su propio tiempo estimado';

  @override
  String get tutorialSubtasksStep4 =>
      'La tarea principal muestra progreso basado en subtareas completadas';

  @override
  String get tutorialSubtasksStep5 =>
      'Las subtareas ayudan a dividir tareas complejas en pasos manejables';

  @override
  String get tutorialSubtasksStep6 =>
      'Puedes añadir, editar o eliminar subtareas en cualquier momento';

  @override
  String get tutorialSubtasksStep7 =>
      'La tarea principal se completa cuando todas las subtareas están hechas';

  @override
  String get tutorialEstimationStep1 =>
      'Al crear o editar una tarea, busca el botón \"Estimar tarea\"';

  @override
  String get tutorialEstimationStep2 =>
      'Tu nivel de energía actual impacta directamente la estimación de tareas';

  @override
  String get tutorialEstimationStep3 =>
      'Niveles de energía más altos sugieren tiempos de finalización más cortos y menos subdivisión necesaria';

  @override
  String get tutorialEstimationStep4 =>
      'Niveles de energía más bajos pueden requerir dividir tareas en trozos más pequeños y manejables';

  @override
  String get tutorialEstimationStep5 =>
      'La aplicación considera tus patrones de energía al sugerir estimaciones de tiempo';

  @override
  String get tutorialEstimationStep6 =>
      'Los tiempos estimados ayudan con la programación y bloques de tiempo';
  ...
  String get tutorialHabitsStep2 =>
      'Elige el icono de hábito de la cuadrícula de iconos O toca el botón \"Añadir Hábito\"';
  ...
  String get tutorialHabitsStep4 =>
      'Ingresa el nombre del hábito (ej., \"Beber 8 vasos de agua\")';

  @override
  String get tutorialHabitsStep5 =>
      'Elige la frecuencia: diario, semanal o personalizado';

  @override
  String get tutorialHabitsStep6 =>
      'Para frecuencia personalizada, selecciona días específicos de la semana';

  @override
  String get tutorialHabitsStep7 =>
      'Establece veces objetivo por día si aplica';
  ...
  String get tutorialHabitsStep9 =>
      'Guarda tu hábito y márcalo como completo cada día que lo hagas';
  ...
  String get tutorialStreaksStep2 =>
      'Cada hábito muestra si fue completado hoy';

  @override
  String get tutorialStreaksStep3 =>
      'Toca la casilla de verificación de un hábito para marcarlo como completo para el día';

  @override
  String get tutorialStreaksStep4 =>
      'Marca hábitos como completos diariamente para mantener rachas';

  @override
  String get tutorialStreaksStep5 =>
      'Las rachas se reinician si pierdes un día (basado en tu frecuencia)';

  @override
  String get tutorialStreaksStep6 =>
      'Usa la pantalla de reportes para ver tu historial de hábitos';

  @override
  String get tutorialStreaksStep7 =>
      'Apunta a la consistencia en lugar de la perfección';

  @override
  String get tutorialStreaksStep8 =>
      'Celebra rachas de hitos para mantenerte motivado';
  ...
  String get tutorialSymptomsStep2 =>
      'Elige el icono de síntoma de la cuadrícula de iconos O toca el botón \"Añadir Síntoma\"';
  ...
  String get tutorialSymptomsStep4 =>
      'Elige de categorías comunes o añade una personalizada';

  @override
  String get tutorialSymptomsStep5 =>
      'Califica la severidad en una escala de 1-10 (usa escala Mankoski si prefieres)';

  @override
  String get tutorialSymptomsStep6 =>
      'Añade notas sobre desencadenantes, contexto o tratamientos probados';

  @override
  String get tutorialSymptomsStep7 =>
      'Incluye ubicación en el cuerpo si aplica';

  @override
  String get tutorialSymptomsStep8 =>
      'Guarda la entrada para rastrear patrones a lo largo del tiempo';
  ...
  String get tutorialMedicationStep2 =>
      'Elige el icono de medicamento de la cuadrícula de iconos';
  ...
  String get tutorialMedicationStep4 =>
      'Ingresa el nombre del medicamento y cantidad de dosis';

  @override
  String get tutorialMedicationStep5 =>
      'Selecciona la unidad (mg, ml, tabletas, etc.)';

  @override
  String get tutorialMedicationStep6 =>
      'Establece la frecuencia: diario, semanal, según sea necesario, o horario personalizado';

  @override
  String get tutorialMedicationStep7 =>
      'Guarda el medicamento y márcalo como tomado cuando tomes tu dosis';
  ...
  String get tutorialMoodStep2 =>
      'Elige el icono de estado de ánimo de la cuadrícula de iconos';
  ...
  String get tutorialMoodStep4 =>
      'Selecciona tu nivel de estado de ánimo actual en una escala de 1-10';

  @override
  String get tutorialMoodStep5 =>
      'Añade notas sobre qué influyó en tu estado de ánimo';

  @override
  String get tutorialMoodStep6 =>
      'Incluye cualquier desencadenante, evento o circunstancia relevante';

  @override
  String get tutorialMoodStep7 =>
      'Nota cualquier estrategia de afrontamiento utilizada';

  @override
  String get tutorialMoodStep8 =>
      'Guarda la entrada de estado de ánimo para rastrear patrones a lo largo del tiempo';
  ...
  String get tutorialEnergyStep2 =>
      'Elige el icono de energía de la cuadrícula de iconos';
  ...
  String get tutorialEnergyStep4 =>
      'Selecciona tu nivel de energía actual en una escala de 1-10';

  @override
  String get tutorialEnergyStep5 =>
      'Añade notas sobre qué influyó en tu energía';
  ...
  String get tutorialFlowmodoroStep1 =>
      'Navega a la página de Gestión del Tiempo';
  ...
  String get tutorialFlowmodoroStep3 =>
      'Elige una tarea en la que trabajar de tu lista de tareas';

  @override
  String get tutorialFlowmodoroStep4 =>
      'Establece tu duración de trabajo (comienza con 25 minutos si no estás seguro)';

  @override
  String get tutorialFlowmodoroStep5 =>
      'Establece tu duración de descanso (típicamente 5-15 minutos)';

  @override
  String get tutorialFlowmodoroStep6 =>
      'Toca \"Iniciar\" para comenzar el temporizador de trabajo';

  @override
  String get tutorialFlowmodoroStep7 =>
      'Trabaja enfocado en tu tarea hasta que termine el temporizador';

  @override
  String get tutorialFlowmodoroStep8 =>
      'Toma el descanso cuando se te indique - aléjate del trabajo';

  @override
  String get tutorialFlowmodoroStep9 =>
      'Después del descanso, inicia otra sesión de trabajo o termina';

  @override
  String get tutorialFlowmodoroStep10 =>
      'Rastrea tus sesiones completadas para insights de productividad';

  @override
  String get tutorialKanbanStep1 =>
      'Ve a Gestión del Tiempo y selecciona \"Kanban\"';

  @override
  String get tutorialKanbanStep2 =>
      'Tus tareas están organizadas en columnas: Por Hacer, En Progreso, Hecho';
  ...
  String get tutorialKanbanStep4 =>
      'Añade nuevas tareas directamente a la columna Por Hacer';

  @override
  String get tutorialKanbanStep5 =>
      'Mueve tareas a En Progreso cuando comiences a trabajar en ellas';
  ...
  String get tutorialKanbanStep7 =>
      'Usa filtros para mostrar solo categorías específicas o prioridades';

  @override
  String get tutorialKanbanStep8 =>
      'Personaliza columnas y flujo de trabajo para que coincida con tus necesidades';

  @override
  String get tutorialTimeBlocksStep1 =>
      'Navega a Gestión del Tiempo y toca \"Bloques de Tiempo\"';

  @override
  String get tutorialTimeBlocksStep2 =>
      'Ve tu calendario con elementos programados existentes';

  @override
  String get tutorialTimeBlocksStep3 =>
      'Para programar una tarea: establece una hora de inicio y una hora de fin, o establece solo una hora de inicio si la tarea tiene una estimación de tiempo';

  @override
  String get tutorialTimeBlocksStep4 =>
      'Para desprogramar: presiona el botón x en la parte superior del elemento programado';

  @override
  String get tutorialTimeBlocksStep5 =>
      'La codificación de colores ayuda a distinguir las prioridades de las tareas';
  ...
  String get tutorialReportsStep2 =>
      'Elige tu rango de tiempo: día, semana, mes o año';

  @override
  String get tutorialReportsStep3 =>
      'Si hay datos que no quieres ver, haz clic en ellos en la leyenda para ocultarlos';

  @override
  String get tutorialReportsStep4 =>
      'Los gráficos se actualizan automáticamente basado en tus selecciones';

  @override
  String get tutorialReportsStep5 =>
      'Pasa el cursor o toca puntos de datos para información detallada';

  @override
  String get tutorialReportsStep6 =>
      'Usa gráficos para identificar patrones y tendencias en tus datos';

  @override
  String get tutorialCustomReportsStep1 =>
      'En la sección de Reportes, busca la leyenda debajo de los gráficos';

  @override
  String get tutorialCustomReportsStep2 =>
      'Toca cualquier elemento en la leyenda para ocultar/mostrar esa serie de datos';

  @override
  String get tutorialCustomReportsStep3 =>
      'Los elementos ocultos aparecen en gris en la leyenda';

  @override
  String get tutorialCustomReportsStep4 =>
      'Esto te permite enfocarte en puntos de datos específicos';

  @override
  String get tutorialCustomReportsStep5 =>
      'Por ejemplo, oculta los hábitos para ver otros elementos más claramente';

  @override
  String get tutorialCustomReportsStep6 =>
      'Combina con filtros de fecha para análisis preciso';
  ...
  String get tutorialSettingsStep2 =>
      'Personaliza tu tema (claro, oscuro o sistema)';
  ...
  String get tutorialAccountStep2 =>
      'Ve los detalles de tu cuenta y dirección de correo electrónico';

  @override
  String get tutorialAccountStep3 =>
      'Cambia tu contraseña o correo electrónico si es necesario';
  ...
  String get securityVerificationRequired =>
      'Por seguridad, por favor verifica tu contraseña actual para cambiar tu dirección de correo electrónico.';

  @override
  String get passwordChangeVerification =>
      'Por seguridad, por favor verifica tu contraseña actual antes de establecer una nueva.';

  @override
  String get passwordRequiredForEmailChange =>
      'Tu contraseña es requerida para verificar este cambio de seguridad';
  ...
  String get emailMustBeDifferent =>
      'El nuevo correo electrónico debe ser diferente del actual';
  ...
  String get emailVerificationSent =>
      'Se ha enviado un correo de verificación a tu nueva dirección de correo electrónico:';

  @override
  String get emailVerificationInstructions =>
      'Por favor revisa tu bandeja de entrada y haz clic en el enlace de verificación para completar el cambio de correo electrónico. Tu dirección de correo electrónico no se actualizará hasta que sea verificada.';
  ...
  String get failedToResendVerification =>
      'Falló al reenviar el correo de verificación';
  ...
  String get emailChangeVerificationMessage =>
      'Para cambiar su dirección de correo electrónico, primero debe verificar su correo electrónico actual. Esto es un requisito de seguridad';
  ...
  String get emailVerificationInstructions2 =>
      'Enviaremos un correo electrónico de verificación a tu dirección actual. Por favor, verifícalo y luego intenta cambiar tu email de nuevo';

  @override
  String get verificationEmailSent2 =>
      'Correo electrónico de verificación enviado a tu dirección actual';

  @override
  String get failedToSendVerification =>
      'Falló el envío del email de verificación';
  ...
  String get emailVerificationRequired =>
      'Se requiere verificación de correo electrónico antes de cambiar la dirección de correo electrónico';
